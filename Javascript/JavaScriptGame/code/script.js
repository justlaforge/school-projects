...
// NOTICE: The majority of this code comes from the youtube video linked above, any 
// feature added by myself is commented with "ADDED LINE(S)"
...
Array.prototype.last = function () {
  ...
  function resetGame() {
    ...
    newHighScoreElement.style.opacity = 0; // ADDED LINE
  ...
  function animate(timestamp) {
    ...
    switch (phase) {
      ...
      case "falling": {
        ...
        if (heroY > maxHeroY) {
          if(score>highscore){
            newHighScoreElement.style.opacity = 1; // ADDED LINE
          }
